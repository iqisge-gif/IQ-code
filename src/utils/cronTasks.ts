// Scheduled prompts, stored in <project>/.doge/scheduled_tasks.json.
//
...
/**
 * Read and parse .doge/scheduled_tasks.json. Returns an empty task list if the file
...
/**
 * Overwrite .doge/scheduled_tasks.json with the given tasks. Creates .doge/ if
 ...
 * written to .doge/scheduled_tasks.json and dies with the process. The
