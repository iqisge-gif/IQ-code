// Non-React scheduler core for .doge/scheduled_tasks.json.
...
type CronSchedulerOptions = {
  ...
  /**
   * Directory containing .doge/scheduled_tasks.json. When provided, the
...
export function buildMissedTaskNotification(missed: CronTask[]): string {
  ...
  const header =
    ...
    `${plural ? 'They have' : 'It has'} already been removed from .doge/scheduled_tasks.json.\n\n` +
