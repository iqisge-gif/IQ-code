 ...
 * user's ~/.doge/settings.json can't redirect requests away from the
 ...
 *
 * - userSettings (~/.doge/settings.json): controlled by the user, not project-specific
...
export function applySafeConfigEnvironmentVariables(): void {
  ...
  // doesn't get clobbered by ~/.doge/settings.json env (gh#217). policy/flag
