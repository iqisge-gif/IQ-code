  ...
  if (shouldAllowManagedHooksOnly()) {
    ...
    try {
      ...
      if (
        ...
        userGuidance =
          'This appears to be a configuration issue. Check your plugin settings in .doge/settings.json'
      } else {
        userGuidance =
      ...
      // from .doge/settings.json (loaded via captureHooksConfigSnapshot) will still work
    }
  }
